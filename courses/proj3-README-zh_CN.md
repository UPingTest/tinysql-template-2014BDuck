...
TinySQL 中的异步 schema 变更是参照了 Google F1 中的 schema 变更的算法。F1 的原始论文可以在 [这里](http://static.googleusercontent.com/media/research.google.com/zh-CN//pubs/archive/41376.pdf) 找到。同时在 [这里](https://github.com/ngaut/builddatabase/blob/master/f1/schema-change.md) 有一份中文版的说明。
